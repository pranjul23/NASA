...
int main (int argc, char *argv[])
{
 ...
 /* int num_hidden_nodes = 8;
  ...
  int num_training_examples = 2000;
  int num_testing_examples = 1175;
  int num_columns = 61;
  int num_obs_vars = 60;
...
/*  vector<int> jtemplate_vec(jtree_nodes, 0);
 ...
 /* int EM_jtree_nodes = num_observed_nodes;
  ...
  double likeZero2 = EMtreeZero2.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  JTree EMtreeZero3(bayesNet0, EM_tree_matrix, EM_nodes_to_vars, train_samples0, EM_thresh);
   double likeZero3 = EMtreeZero3.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  double likeZero4 = EMtreeZero4.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  double likeZero5 = EMtreeZero5.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  double likeOne2 = EMtreeOne2.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  double likeOne3 = EMtreeOne3.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  double likeOne4 = EMtreeOne4.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  double likeOne5 = EMtreeOne5.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  double likeTwo2 = EMtreeTwo2.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  double likeTwo3 = EMtreeTwo3.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  double likeTwo4 = EMtreeTwo4.LearnEMParameters(EM_FLAG_MULT, 0);
  ...
  double likeTwo5 = EMtreeTwo5.LearnEMParameters(EM_FLAG_MULT, 0);
...
//	if (likeTwo1 > likeTwo2 && likeTwo1 > likeTwo3 && likeTwo1 > likeTwo4 && likeTwo1 > likeTwo5)
	...
	{
		EM_val2 = EMtreeTwo1.ComputeEmpiricalMarginals(marginals, EM_evidence_vars, EM_evidence_vals);
	}
