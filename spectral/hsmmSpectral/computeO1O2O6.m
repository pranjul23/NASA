...
function O1O2O6 = computeO1O2O6(A1, A, D1, D, O)
        ...
        for ind_d2 = 1:x
            ...
            for ind_d1 = 1:d
                ...
                O1X2D2(ind_o1, ind_x2, ind_d2) = O1X2D2(ind_o1, ind_x2, ind_d2) + ...
                    O(ind_o1, ind_x1) * D(ind_d2, ind_x2, ind_d1) * A(ind_x2, ind_x1, ind_d1) * D1(ind_d1, ind_x1) * A1(ind_x1);
    ...
    for ind_o2 = 1:o
        for ind_o6 = 1:o
            ...
            for ind_d2 = 1:d
                ...
                O1O2O6(ind_o1, ind_o2, ind_o6) = O1O2O6(ind_o1, ind_o2, ind_o6) + ...
                    O1X2D2(ind_o1, ind_x2, ind_d2) * O(ind_o2, ind_x2) * O6X2D2(ind_o6, ind_x2, ind_d2);
            end
            end
