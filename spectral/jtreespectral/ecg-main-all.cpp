...
int main (int argc, char *argv[])
{
 ...
 /* int num_hidden_states = 2;
  ...
  int EM_FLAG = 1;
  int num_hidden_nodes = 85;
  int num_observed_nodes = 85;
...
//  int num_training_examples = 2675;
  int num_testing_examples = 1216;
  int num_columns = 86;
  int num_obs_vars = 85;

  string train_file_name = "ecg_train-" + to_string(trial) + ".txt";
  string test_file_name = "ecg_test-" + to_string(trial) + ".txt";
...
/*	cout << EM_val0;
  ...
  string outfile_name = "ecg-" + to_string(num_hidden_states) + "-"
