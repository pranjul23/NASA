...
%remove zero rows (extra left after preallocaiton of space)
endPoints(c1:end, :) = [];
fileNames(c2:end) = [];
...
[actions rates data_proc startInd endInd ind_bad] = extractPilotActions(data);

save('../../spectral/hsmmSpectral/data.mat', 'actions', 'rates', 'data', 'data_proc', 'startInd', 'endInd', 'ind_bad');
